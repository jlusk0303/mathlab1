...
return 9 * s;
	...
	public static double hexagonArea (double b, double b2, double h)             
	{ 
	    return 4 * 5; 
	}
	...
	public static double trapezoidArea (double b, double b2, double h)
	{
	return 8 *10* 6;
	}
	...
	public static double rectangularPrismVolume (double s, double w, double h)             
	{ 
	    return 8*8; 
	}
